...
class Enqueue extends BaseController
{
	...
	function enqueueFront() {
		...
		wp_enqueue_style( 'mbwp-style', $this->plugin_url . 'assets/front/css/style.css' );
		wp_enqueue_script( 'mbwp-script', $this->plugin_url . 'assets/front/js/bundle.js', array(), false, true );
	}
}